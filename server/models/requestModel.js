...
// const queryString2 = `CREATE TABLE IF NOT EXISTS orgs(id SERIAL PRIMARY KEY, name varchar(255) NOT NULL);`


// const queryString3 = "CREATE TABLE IF NOT EXISTS topics(id SERIAL PRIMARY KEY, name varchar(255), description varchar(255));"

// const queryString4 = `CREATE TABLE IF NOT EXISTS items(id SERIAL PRIMARY KEY, topics_id integer NOT NULL, name varchar(255) NOT NULL, 
// description varchar(255), vote integer, FOREIGN KEY (topics_id) REFERENCES topics(id) ON DELETE CASCADE);`

// const queryString5 = `CREATE TABLE IF NOT EXISTS userorg(id SERIAL PRIMARY KEY, user_id int NOT NULL, org_id int NOT NULL, 
