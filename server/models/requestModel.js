...
const queryString3 = `CREATE TABLE IF NOT EXISTS items(id SERIAL PRIMARY KEY, topics_id integer NOT NULL, name varchar(255), 
description varchar(255), vote integer, FOREIGN KEY (topics_id) REFERENCES topics(id) ON DELETE CASCADE);`
const queryString4 = "CREATE TABLE IF NOT EXISTS topics(id SERIAL PRIMARY KEY, name varchar(255), description varchar(255));"
